...
class SKNet(nn.Module):
    def __init__(self, nums_class=1000, nums_block_list=[3, 4, 6, 3]):
        ...
        self.layer1 = self._make_layer(SKBlock, 128, nums_block_list[0], stride=1)
        self.layer2 = self._make_layer(SKBlock, 256, nums_block_list[1], stride=2)
        self.layer3 = self._make_layer(SKBlock, 512, nums_block_list[2], stride=2)
        self.layer4 = self._make_layer(SKBlock, 1024, nums_block_list[3], stride=2)
        self.avgpool = nn.AdaptiveAvgPool2d(1)
        self.fc = nn.Linear(1024 * SKBlock.expansion, nums_class)
